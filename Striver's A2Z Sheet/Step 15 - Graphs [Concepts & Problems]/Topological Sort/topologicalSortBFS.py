...
# QUESTION: Topological Sort / Kahn's Algorithm (BFS)
...
# ordering of its vertices using a Breadth-First Search based approach
# (Kahn's Algorithm).
...
# Output: [4, 5, 0, 2, 3, 1]
# Explanation: Kahn's algorithm repeatedly removes vertices with in-degree 0. For
# every edge u -> v, u appears before v. Any valid ordering is accepted.
#
# Constraints:
# 1 <= V <= 10^4
...
if __name__ == "__main__":
    sol = Solution()
    # sol.topological_sort_bfs_optimal(6, [[], [], [3], [1], [0, 1], [0, 2]])
