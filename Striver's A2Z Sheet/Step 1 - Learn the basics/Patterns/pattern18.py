...
# QUESTION: Pattern 18 - Alphabet Right Triangle (Suffix)
...
2. Row i prints the last i+1 uppercase letters ending at A+n-1, i.e. starting at A+n-1-i.
TC -> O(n^2), SC -> O(1)

#KEY INSIGHT:
- Row i prints the last i+1 uppercase letters ending at A+n-1, i.e. starting at A+n-1-i.
"""
