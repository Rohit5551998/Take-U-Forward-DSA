...
# QUESTION: Pattern 7 - Star Pyramid
...
2. Each row = (n-i-1) leading spaces + (2*i+1) stars. Spaces shrink, stars grow, keeping it centred.
TC -> O(n^2), SC -> O(1)

#KEY INSIGHT:
- Each row = (n-i-1) leading spaces + (2*i+1) stars. Spaces shrink, stars grow, keeping it centred.
"""
