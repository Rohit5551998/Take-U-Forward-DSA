...
# QUESTION: Pattern 2 - Right-Angled Triangle (Stars)
...
2. Row i (0-indexed) prints i+1 stars: link the inner loop count to the current row index.
TC -> O(n^2), SC -> O(1)

#KEY INSIGHT:
- Row i (0-indexed) prints i+1 stars: link the inner loop count to the current row index.
"""
