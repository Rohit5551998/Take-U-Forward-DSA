...
class Solution:
    def floor_in_a_bst_brute(self, root: Optional[TreeNode], key: int) -> int:
        pass

    def floor_in_a_bst_better(self, root: Optional[TreeNode], key: int) -> int:
        pass

    def floor_in_a_bst_optimal(self, root: Optional[TreeNode], key: int) -> int:
        pass
...
if __name__ == "__main__":
    ...
    key = 11
    print(sol.floor_in_a_bst_optimal(root, key))
