...
class Solution:
    def find_k_th_smallest_element_in_bst_brute(
        self, root: Optional[TreeNode], k: int
    ) -> List[int]:
        pass

    def find_k_th_smallest_element_in_bst_better(
        self, root: Optional[TreeNode], k: int
    ) -> List[int]:
        pass

    def find_k_th_smallest_element_in_bst_optimal(
        self, root: Optional[TreeNode], k: int
    ) -> List[int]:
        pass
...
if __name__ == "__main__":
    ...
    k = 1
    print(sol.find_k_th_smallest_element_in_bst_optimal(root, k))
