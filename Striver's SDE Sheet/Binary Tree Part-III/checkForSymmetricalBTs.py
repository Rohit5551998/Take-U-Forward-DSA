...
class Solution:
    def check_for_symmetrical_bts_brute(self, root: Optional[TreeNode]) -> bool:
        pass

    def check_for_symmetrical_bts_better(self, root: Optional[TreeNode]) -> bool:
        pass

    def check_for_symmetrical_bts_optimal(self, root: Optional[TreeNode]) -> bool:
        pass
...
if __name__ == "__main__":
    ...
    print(sol.check_for_symmetrical_bts_optimal(root))
