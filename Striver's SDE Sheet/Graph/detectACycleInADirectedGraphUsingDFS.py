...
class Solution:
    def detect_a_cycle_in_a_directed_graph_using_dfs_brute(
        self, v: int, adj: List[List[int]]
    ) -> bool:
        pass

    def detect_a_cycle_in_a_directed_graph_using_dfs_better(
        self, v: int, adj: List[List[int]]
    ) -> bool:
        pass

    def detect_a_cycle_in_a_directed_graph_using_dfs_optimal(
        self, v: int, adj: List[List[int]]
    ) -> bool:
        pass
...
if __name__ == "__main__":
    ...
    v = 6
    adj = [[1], [2, 5], [3], [4], [1], []]
    print(sol.detect_a_cycle_in_a_directed_graph_using_dfs_optimal(v, adj))
