...
class Solution:
    def detect_a_cycle_in_undirected_graph_using_dfs_brute(self) -> None:
        pass

    def detect_a_cycle_in_undirected_graph_using_dfs_better(self) -> None:
        pass

    def detect_a_cycle_in_undirected_graph_using_dfs_optimal(self) -> None:
        pass
