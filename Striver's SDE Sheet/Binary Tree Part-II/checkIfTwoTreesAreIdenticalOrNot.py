...
def check_if_two_trees_are_identical_or_not_brute() -> None:
    pass


def check_if_two_trees_are_identical_or_not_better() -> None:
    pass


def check_if_two_trees_are_identical_or_not_optimal() -> None:
    pass
